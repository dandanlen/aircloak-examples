...
class MetricsPlot:
    """A Helper class for visualising different classes of metrics using plotly express."""

    def __init__(self, metrics_raw):
        self.metrics_raw = metrics_raw
        self.metrics = {metric["name"]: metric["value"] for metric in metrics_raw}
